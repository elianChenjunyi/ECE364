...
def main():
    ...
    model.train(
        ...
        imgsz=1280,       # Input image size (higher helps small object detection)
        ...
        freeze=0,               # Freeze first 10 layers for fine-tuning
        patience=30,             # Early stopping after 20 rounds without improvement
        box=0.1,
        ...
        mixup=0.15,         # MixUp augmentation (disabled here)
